...
- `empirical-prompt-tuning` — tuning during prompt development. This skill is for codifying lessons after a task ends; empirical is during prompt development. Use them differently.
...
Imported from https://github.com/mizchi/skills/blob/main/retrospective-codify/SKILL.md
